 ...
 */
final class Version20260524171126 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE building_cost (id INT AUTO_INCREMENT NOT NULL, quantity INT NOT NULL, building_type_id INT NOT NULL, resource_type_id INT NOT NULL, INDEX IDX_BE02E3A8F28401B9 (building_type_id), INDEX IDX_BE02E3A898EC6B7B (resource_type_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
