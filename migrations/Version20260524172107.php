 ...
 */
final class Version20260524172107 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE building_cost CHANGE quantity cost INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE building_cost CHANGE cost quantity INT NOT NULL');
