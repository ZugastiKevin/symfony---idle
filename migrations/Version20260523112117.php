 ...
 */
final class Version20260523112117 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_2AFA207D77153098 ON building_type (code)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_2AFA207D77153098 ON building_type');
