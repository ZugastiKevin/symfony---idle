 ...
 */
final class Version20260525103356 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE building ADD resource_deposit_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_E16F61D4F80DA337 ON building (resource_deposit_id)');
        ...
        $this->addSql('ALTER TABLE resource_deposit ADD latitude DOUBLE PRECISION NOT NULL, ADD longitude DOUBLE PRECISION NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_E16F61D4F80DA337 ON building');
        $this->addSql('ALTER TABLE building DROP resource_deposit_id');
        ...
        $this->addSql('ALTER TABLE resource_deposit DROP latitude, DROP longitude');
