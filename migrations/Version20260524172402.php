 ...
 */
final class Version20260524172402 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE building_cost CHANGE cost costs INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE building_cost CHANGE costs cost INT NOT NULL');
