 ...
 */
final class Version20260523165606 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP latitude_base, DROP longitude_base');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD latitude_base DOUBLE PRECISION DEFAULT NULL, ADD longitude_base DOUBLE PRECISION DEFAULT NULL');
    }
}
