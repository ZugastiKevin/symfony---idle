 ...
 */
final class Version20260521173052 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE player_resource (id INT AUTO_INCREMENT NOT NULL, iron INT NOT NULL, stone INT NOT NULL, water INT NOT NULL, oil INT NOT NULL, updated_at DATETIME NOT NULL, player_id INT NOT NULL, UNIQUE INDEX UNIQ_BA46B5F699E6F5DF (player_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('ALTER TABLE player_resource ADD CONSTRAINT FK_BA46B5F699E6F5DF FOREIGN KEY (player_id) REFERENCES user (id)');
        ...
        $this->addSql('ALTER TABLE resource_deposit ADD richness DOUBLE PRECISION NOT NULL, DROP quantity');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE player_resource DROP FOREIGN KEY FK_BA46B5F699E6F5DF');
        ...
        $this->addSql('ALTER TABLE resource_deposit ADD quantity INT NOT NULL, DROP richness');
