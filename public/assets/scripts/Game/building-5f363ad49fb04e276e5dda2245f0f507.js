...
async function loadUpgradeInfoAsync(buildingId, marker, buildingData) {
    ...
    try {
        ...
        const pollInterval = setInterval(loadPopupContent, 3000);

        // Stocker l'intervalID pour pouvoir l'arrêter plus tard
        buildingMarkers.set(buildingId, { marker, data: buildingData, pollInterval });
