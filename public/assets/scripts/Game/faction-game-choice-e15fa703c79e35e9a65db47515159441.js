 ...
 */
(function() {
    console.log('FactionGameChoice: Script chargé');

    function initSelection() {
        console.log('FactionGameChoice: Initialisation');
        ...
        document.querySelectorAll('.game-card').forEach(card => {
            ...
            if (radio) {
                radio.addEventListener('change', function() {
                    console.log('Game selected:', this.checked);
        ...
        document.querySelectorAll('.faction-card').forEach(card => {
            ...
            if (radio) {
                radio.addEventListener('change', function() {
                    console.log('Faction selected:', this.checked);
